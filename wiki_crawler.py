#############
#Created by Andrea Ceolin - May 20th 2018
#############
...
#create a .tsv file that contains only the lines we are interested in (A-B-A interactions)
        ...
        for file in os.listdir('wikimedia/' + directory):
            ...
            for key in d:
                ...
                if len(d[key]) > 2:
                    ...
                    #make sure that we don't have the same author writing three comments in a row
